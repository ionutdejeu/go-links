 ...
 */
export const parsePluginConfig = (plugin: any[] | Function): {
 ...
 */
export const composePlugins = (phase: string, plugins: any[], initialConfig: Record<string, any>): Record<string, any> => {
